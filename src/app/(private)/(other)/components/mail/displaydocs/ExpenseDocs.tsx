    ...
    const ExpensePDF = () => (
            <Page size="A4" style={expenseStyles.page}>
                ...
                <View style={expenseStyles.table}>
                    {/* Header Row */}
                    <View style={[expenseStyles.row, expenseStyles.header]}>
                        <Text style={expenseStyles.cell}>Date</Text>
                        <Text style={expenseStyles.paymentTypeCell}>Payment Type</Text>
                        <Text style={expenseStyles.companyCell}>Company</Text>
                        <Text style={expenseStyles.cell}>Detail</Text>
                        <Text style={expenseStyles.cell}>Amount</Text>
                    </View>

                    {/* Data Rows */}
                    {mappedExpenses.map((expense) => (
                        <View style={expenseStyles.row} key={expense.id}>
                            <Text style={expenseStyles.cell}>{expense.date}</Text>
